...
function Interactions() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-600 mb-4">Check interactions between 2 or more medicines.</p>
      ...
      {results && (
        <div className="mt-6 flex flex-col gap-3">
          <h2 className="font-semibold">Results ({results.length} pair{results.length !== 1 ? 's' : ''} checked)</h2>
          {results.map((r, i) => (
            <div key={i} className="border rounded-lg p-4">
              <div className="font-medium mb-1">{r.drug_a} + {r.drug_b}</div>
